 ...
 *  3) results_stacked.svg (stacked bars: green pass / red fail / yellow pending)
 */
...
<body>
  <div class="wrap">
    ...
    <div class="charts">
      ...
      <img src="charts/results_stacked.svg" alt="Results stacked chart"/>
    </div>
...
function main() {
  ...
  svgStackedResultsChart({
    runs,
    fileName: "results_stacked.svg",
  });
  ...
  console.log(`   ${path.join(outChartsDir, "results_stacked.svg")}`);
